...
#             else "success" if status == "SUCCESS"
#             else "failed" if status == "FAILED"
#             else "unknown"
#         )
#         task_start_time = info.get('start_time')
#         task_end_time = info.get('end_time')

#         task_rows += f"""
#         <tr class="{status_class}">
#             <td>{task_name}</td>
#             <td><span class="badge {status_class}">{status}</span></td>
#             <td>{task_start_time.strftime('%H:%M:%S') if task_start_time else 'N/A'}</td>
#             <td>{task_end_time.strftime('%H:%M:%S') if task_end_time else 'N/A'}</td>
#             <td>{info.get('execution_time', 'N/A')}</td>
#             <td>{info.get('error', '')}</td>
#         </tr>
#         """
